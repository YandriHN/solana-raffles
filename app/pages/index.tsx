  ...
  useEffect(() => {
    ...
    return (
        <div className={styles.container}>
          ...
          <h3>Disclaimer</h3>
          <p>Solana Raffles is providing a service to host raffles, we do not endorse any raffles hosted on this site - please use discretion when participating.</p>
          </div>
          
          <hr style={{margin:'50px 0'}}/>

{loading ? <div className={styles.loading}> <ScaleLoader color='white' loading={loading}/></div> :
            raffles && raffles
}
        </div>
    );
